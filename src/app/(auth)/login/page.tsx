...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setError(message.includes("invalid-credential")
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-bold text-lg tracking-tight">MedPredict</span>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <div>
            ...
            <p className="text-slate-400 mt-4 text-base leading-relaxed max-w-sm">
              AI-powered predictive maintenance for Nigerian healthcare facilities. Keep critical equipment running.
            </p>
          </div>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-sm">
            ...
            <div>
              <div className="text-white text-sm font-medium">Dr. Amaka Okonkwo</div>
              <div className="text-slate-400 text-xs">Lagos University Teaching Hospital</div>
            </div>
          ...
          <p className="text-slate-500 text-xs mt-3 px-1 italic">
            &ldquo;MedPredict reduced our equipment downtime by 67% in the first quarter.&rdquo;
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400 text-sm mt-1">Access your hospital dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                required placeholder="doctor@hospital.ng"
